...
hard_questions = [
    ...
    {
        "question": "Какой библейский образ используется для описания испытаний веры и страданий?",
        "options": [
        "Золото испытывается в огне",
        "Терпение рождает опытность",
        "Страдание очищает душу",
        "Вера без дел мертва"
    ],
        "correct": 0,
        "explanation": "Образ испытания золота огнём используется в 1 Пет. 1:7, где вера уподобляется золоту, очищаемому через страдания (Зах. 13:9; Иов 23:10)."
    },
    {
