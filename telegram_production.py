...
async def _start(update, context):
    ...
    # Course deep links are resolved by the canonical catalog. Unknown tokens
    # preserve the historical fallback-to-main-menu behavior.
...
async def _menu(update, context):
    """Open the main menu without allowing command args to reach deep-link routing."""
