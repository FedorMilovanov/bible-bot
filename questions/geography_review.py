...
GEOGRAPHY_OVERRIDES = {    "geo_01": {
        "explanation": (
            ...
            "провинции, названные в 1 Пет. 1:1 (Pleiades Gazetteer). Такая география объясняет, "
    ...
    "geo_04": {
        "explanation": (
            ...
            "знаменитым центром культа Артемиды (Oxford Classical Dictionary). Сам Эфес в "
    ...
    "geo_05": {
        ...
        "explanation": (
            ...
            "Эгейское), а северное — к Чёрному, которое омывало Вифинию и Понт (Pleiades "
            "Gazetteer). Адресаты 1 Пет. 1:1 жили и в прибрежных, и во внутренних областях."
        ),
        "sources": ["pleiades_gazetteer", "orbis_roman_network"],
    },
    "geo_06": {
        "explanation": (
            ...
            "паломничества (Pleiades Gazetteer). Для 1 Петра это важно потому, что его читатели "
    ...
    "geo_09": {
        "explanation": (
            "Римская дорожная сеть (viae) связывала города и провинции империи и вместе с "
