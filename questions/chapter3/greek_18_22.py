...
GREEK_3_18_22 = [
    ...
    _g("ch3_gr_006", "ἐπερώτημα", "1 Пет. 3:21", "Noun, nom. neut. sg.", ["Noun, gen. neut. sg.", "Adj., nom. neut. sg.", "Infinitive"], "N- ----NSN-", "ἐπερώτημα", "Appeal/pledge/confession — lexical-history dispute, не parsing fact.", ("lsj_eperotema", "ubs_handbook_1p3_21", "jts_crawford_1p3_21")),
    ...
    _g("ch3_gr_011", "πνεύμασιν", "1 Пет. 3:19", "Noun, dat. neut. pl.", ["Noun, dat. masc. pl.", "Noun, gen. neut. pl.", "Adjective, dat. neut. pl."], "N- ----DPN-", "πνεῦμα", "Форма не идентифицирует духов; semantic referent требует экзегезы.", ("pierce_spirits_2011", "grudem_noah_1p3_19")),
