...
THEOLOGY_3_18_22 = [
    _h("ch3_theol_001", "Как project-евангельское чтение синтезирует περὶ ἁμαρτιῶν, δίκαιος ὑπὲρ ἀδίκων и προσαγάγῃ в 3:18?",
       ...
       "Это synthesis всего предложения, не lexical claim об одном ὑπέρ; MacArthur плюс Schreiner дают независимый evangelical project-side quorum.",
    ...
    _h("ch3_theol_003", "Как project-евангельское чтение формулирует βάπτισμα ... σῴζει?",
       ...
       "Это project reading, не parsing fact. MacArthur + Schreiner дают евангельскую сторону; Crawford/Westfall/ICC удерживают реальность лексико-систематического спора.",
