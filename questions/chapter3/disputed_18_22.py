...
DISPUTED_3_18_22 = [
    _d(
        ...
        "MorphGNT даёт лишь πνεῦμα, dat. neut. pl.; fallen-spirit, Christ-through-Noah и descensus/human-dead readings требуют экзегезы и, для последнего, контроля истории рецепции",
