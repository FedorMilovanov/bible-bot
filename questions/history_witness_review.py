...
HISTORY_WITNESS_OVERRIDES = {
    "geo_06": {
        "explanation": (
            ...
            "совершались паломничества. Положение города фиксирует атлас Pleiades, "
    ...
    "nero_12": {
        "explanation": (
            ...
            "Светоний прямо называет его наставником будущего императора («Нерон» 7), а "
            "Тацит описывает, как Сенека и Бурр направляли молодого правителя в первые "
            "годы («Анналы» 13). Позже его влияние ослабло, что отразилось и в его судьбе."
        ),
    ...
    "nero_13": {
        "explanation": (
            ...
            "сцену («Анналы» 15.60–64), и та же развязка известна по Кассию Диону (Roman "
