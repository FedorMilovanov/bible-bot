...
# Chapters 2-4 cross the product boundary only through reviewed aggregates.
...
# random_all remains the legacy Chapter-1/context learning pool. Chapters 2-4
...
# Legacy PvP imports BATTLE_POOL directly. Chapter 4 has no ranking authority.
...
# Fallback stays Chapter-1-only. Chapter 4 is absent from all Challenge paths.
