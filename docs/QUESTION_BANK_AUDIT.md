...
- `levels.*` — распределение по трудности. Индивидуально проверенный когнитивный уровень уже имеют 302 карточки (base 112, core 118, advanced 72). Остальные 457 пока получают только audit-прокси (base 127, core 105, advanced 225) из claim_type/confidence; этот прокси не считается продуктовым уровнем. Развести курсы по уровням можно будет после того, как этот уровень появится у карточки.
